...
let all: [Ingredient] = [
   ...
   Ingredient(ingredientName: "사과", ingredientImage: UIImage(named: "Apple")),
    ...
    Ingredient(ingredientName: "옥수수캔", ingredientImage: UIImage(named: "CornCan")),Ingredient(ingredientName: "스팸", ingredientImage: UIImage(named: "Spam")),
...
let can: [Ingredient] = [
    Ingredient(ingredientName: "옥수수캔", ingredientImage: UIImage(named: "CornCan")),
